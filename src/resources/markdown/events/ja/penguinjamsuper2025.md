...
### プロジェクトを提出する
**タイトルまたはメモに #pjamhero または #pjamvillain というタグを使って、**テーマ関連のプロジェクトをJetPortalにアップロードする必要があります。
...
バッジは段階的に授与されます。**JetPortalチームにバッジをできるだけ早く渡すようプレッシャーをかけないでください。他の業務で忙しい場合もあることをご了承ください。**
