...
## I am a JetPortal user, not moderator
...
## Our expectations
When moderating JetPortal, we expect you to handle conflicts, disagreements, spam, etc with a mature and formal fashion.
...
On top of this, ***do not do anything that intentionally creates problems for the JetPortal team.***
...
- "the content is too sexual for JetPortal"
...
## Base requirements for a project + Projects that display websites (iframes) + JetPortal Mods / Forks
...
## Preventing or Removing access to parts of JetPortal + Use other platforms sparingly
...
- Impersonation can be an account deletion if the account is empty, and a ban if it is of JetPortal staff or so.
