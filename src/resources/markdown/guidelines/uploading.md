...
These guidelines **only apply to JetPortal's project sharing**.
...
Clicking on a "Report" link below a project on JetPortal Studio will open a new tab to report the project.
...
If a user or group is not on JetPortal, you may use their name instead.

Please note, you do not need to credit the use of:
- JetPortal as a platform
- JetPortal extensions used inside the project (custom extensions not included)
...
- Go to the "My Stuff" page (or click the folder icon) on JetPortal's home page and click the 3 dots on any project, then click "Edit Project".
...
If you are just taking a Scratch project that was shared on Scratch and uploading it onto JetPortal, please note the following:
...
The original creators of the project have the right to remove your JetPortal reupload if they report the project.
This is also true even if you have stated you have permission to reupload the project by the original creator.

# JetPortal Mods / Forks
If your project only works outside of JetPortal, don't upload it to our site.
All JetPortal projects should actually work on JetPortal, please upload your project to it's respective site to avoid problems for us.

*(Note for developers: If we get a lot of projects uploaded from your mod that don't work on JetPortal, we'll likely end up blocking your site from the API. See [here for details](https://github.com/PenguinMod/penguinmod.github.io/blob/develop/FORKING.md).)*

# "Chatroom" Projects or Projects based around online chatting
```warning
As of November 14th, 2023, JetPortal has decided to ban uploaded projects based around chatting with other users.
```
...
These types of projects are no longer allowed due to the JetPortal team not being able to control these spaces properly,
...
# Preventing or Removing access to parts of JetPortal
...
Using these actions to prevent remixing or reuploading will be implemented into JetPortal at a later date.
...
# Exploiting or Abusing JetPortal systems
You are not allowed to encourage, create, or upload projects that abuse JetPortal's systems.
This means you can't make projects that:
- Report other users or projects in large amounts (mass-reporting)
- Reward or encourage others to break JetPortal's rules
- Try to get around JetPortal's time limits, like uploading projects too quickly
...
- Abuse a bug/glitch in JetPortal to harm other users or projects
...
- Harassment, intimidation, or humiliation of JetPortal users through other platforms
...
You cannot use JetPortal as a platform for online dating, or creating/sharing romantic or sexual relationships.
You cannot show real people, or characters that represent people doing:
- Dating
- Kissing
- Similar romantic behavior

You should not call other users "boyfriend" or "girlfriend" on JetPortal as other users can be of any age, and we need to keep everyone safe.
...
Do not use JetPortal to break laws in your country, region, or area.
...
# Political content
Please note JetPortal is not a platform for primarily political projects or messages.

Projects that primarily exist to promote political ideologies, parties, candidates, or causes are not allowed on JetPortal.
...
# Copyright
You are responsible for making sure you have the necessary rights, licenses, or permission for any user-generated content you submit to JetPortal.
JetPortal will remove your project if the project violates copyright rules for any specific company or individual, and you may face further punishment.
...
- Using/Repurposing content from another JetPortal user without their permission
