...
<svelte:head>
    <title>JetPortal - Upload</title>
    <meta name="title" content="JetPortal - Upload" />
    <meta property="og:title" content="JetPortal - Upload" />
    <meta property="twitter:title" content="JetPortal - Upload" />
    <meta
        name="description"
        content="Upload your project to JetPortal, for the whole world to see."
    />
    <meta
