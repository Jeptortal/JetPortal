...
<svelte:head>
    <title>JetPortal - Redirecting</title>
...
<div class="center-div">
    ...
    <h1>
        <LocalizedText
            text="You are leaving JetPortal"
            key="redirect.title"
            lang={currentLang}
        />
    </h1>
    <p>
        <LocalizedText
            text="You are leaving JetPortal to visit &qt;{"{{WEBSITE_URL}}"}. Content on this site may not be safe for everyone."
