...
<svelte:head>
    <title>JetPortal - Change Password</title>
    <meta name="title" content="JetPortal - Change Password" />
    <meta property="og:title" content="JetPortal - Change Password" />
    <meta property="twitter:title" content="JetPortal - Change Password" />
    <meta
        name="description"
        content="Change your password for JetPortal to access your account with a new password"
    />
    <meta
